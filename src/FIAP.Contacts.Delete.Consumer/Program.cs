using FIAP.Contacts.Delete.Consumer.Consumers;
using MassTransit;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Hosting;
using FIAP.Contacts.Delete.Application.Shared;
using FIAP.Contacts.Delete.Infra;
using FIAP.Contacts.Delete.Consumer.DI;
...
var host = Host.CreateDefaultBuilder(args)
    ...
    .ConfigureServices((builder, services) =>
    {
        ...
        {
            x.AddConsumer<DeleteContactConsumer>((x) =>
            {
                x.UseMessageRetry(r =>
                {
            ...
            x.UsingRabbitMq((context, cfg) =>
            {
                ...
                cfg.ReceiveEndpoint(config.GetValue("RabbitMq:QueueName", "contact.delete"), e =>
                {
